	...
	<div class="content">
		...
		<nav class="navbar navbar-expand-lg rounded">
		  ...
		  <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
		    <ul class="navbar-nav">
		      <li class="nav-item">
		        <a class="nav-link" href="vertarefas?t=<?php echo $turmaidreg; ?>"><b>Ver tarefas</b></a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="faltasalunos?t=<?php echo $turmaidreg; ?>"><b>Ver faltas</b></a>
		      </li>
		    </ul>
		  </div>
		</nav>
